...
n.test<-as.numeric(test$default.payment.next.month)
...
confusionMatrix(data=lr.class,reference = test$default.payment.next.month,positive = "0")
confusionMatrix(data=nb.class,reference = test$default.payment.next.month,positive = "0")
